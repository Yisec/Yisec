...
import { getType, isPromise, getComponent, getParentCtx, isFunction, isString, resortArr } from './util';
...
function addProperties(element, vdom, ctxs) {
    ...
    resortArr(Object.keys(node.props), ':key', 'v-if', 'v-for', 'v-show').forEach(key => {
